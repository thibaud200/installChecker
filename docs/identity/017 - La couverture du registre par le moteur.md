...
**Statut** : premier acte documentaire opérationnel de la phase v2 de la série `docs/identity/`. S'appuie sur les documents 000→016, tous figés. Exécute le **volet documentaire du report 1** du 016 § 4.1 — l'acte documentaire préalable que ce report exige —, par la voie 2 du 016 § 3 : le document précède le code ; aucune ligne du moteur v2 n'existe à la date du présent acte, et le volet moteur du report 1 (voie 3) reste à entreprendre après validation du présent document.
...
**Raffinement assumé** : ce document raffine le 011 sur **quatre points précis** — le contrat d'erreur (011 § 5 : la liste close s'ouvre d'un cas, motivé au § 6 ci-dessous), les préconditions d'invocation (011 § 4 : une quatrième s'ajoute, motivée au § 4 ci-dessous), le contrat de validation (011 § 8 : la couverture devient composante de la déclaration de conformité, § 3 ; et l'exigence de provocation de son point 4 est bornée au satisfiable, § 10), et la clause de compatibilité des registres (011 § 9, troisième puce : « le moteur applique l'état fourni, quel qu'il soit, pourvu qu'il soit cohérent » — bornée au § 9 ci-dessous). Il porte en outre un **complément assumé du 014 § 1** : la clause « refuse » de C2 gagne un quatrième cas, sa clause « garantit » s'étend, et la portée d'I51 s'étend d'autant (§ 5). Il **s'adosse** au raffinement du 011 § 10 déjà acté par le 016 § 5.1, sans le redéfinir. Les définitions (§§ 2–3), l'articulation des cas de famille (§ 7) et l'ordre des vérifications (§ 8) sont le mécanisme que ces points déclarés instituent ; l'écart publié du § 9 est l'exercice d'un mécanisme figé (011 § 9, I59), jamais un contenu nouveau ; hors ces points, leur mécanisme et les invariants I61–I64 (§ 12), aucun contenu normatif nouveau.
**Périmètre — exclusions constitutives** : rien de ce document n'entre dans le registre (015 § 1 l'interdit ; I53–I56 le verrouillent) ; rien ne décrit l'architecture du composant du report 2 (seul le contrat du siège de vérification est fixé, § 5) et rien ne fixe l'ordre des vérifications entre Ω et ℛ (contrat du porteur du report 2, § 8) ; rien ne touche les reports 3 (forme canonique) et 6 (carte des refus de W₀) ; rien ne contractualise la liste des capacités d'un moteur particulier (I40 : le contrat définit le mécanisme, jamais l'inventaire).
...
**Définition 1 (couverture)** — La *couverture* d'une version de moteur est l'ensemble des **familles de conventions** (celles du 014 § 5.1) que sa déclaration de couverture (§ 3) énonce. Déclarer une famille est un engagement, jamais un constat : le moteur s'oblige à appliquer toute convention conforme de cette famille au sens d'EXG-13 — à la lettre, dans la version indexée, sans latitude d'interprétation. Un moteur qui déclare ce qu'il ne sait pas honorer est non conforme (011 § 8) ; sa couverture n'en est pas réduite pour autant : elle est ce qu'il a déclaré — le défaut est un défaut de conformité, jamais une couverture moindre.
...
- **le contrat définit le mécanisme, jamais l'inventaire** — conformément à I40 (« aucun choix d'implémentation ne peut restreindre, étendre ou réinterpréter le contrat »), le présent document ne **stipule** aucun inventaire : il dit ce qu'est une couverture, comment elle se déclare (§ 3) et ce qu'elle conditionne (§ 4). Qu'une couverture minimale **découle** d'obligations figées n'y contredit pas : le § 10 dérive d'EXG-26 que tout moteur conforme couvre interprétation et élection — un théorème hérité de l'oracle, jamais une clause du présent contrat. Le précédent est exact : le 011 § 9 contractualise « le moteur déclare les versions [du contrat de Ω] qu'il supporte » sans jamais nommer une version.

---

## 3. La déclaration de couverture

**Définition 2 (déclaration de couverture)** — L'énoncé, par version de moteur, d'un ensemble de familles parmi celles du 014 § 5.1. Elle est **constitutive** : la couverture n'existe ni avant elle ni en dehors d'elle (Définition 1) — déclarer, c'est couvrir, et couvrir oblige (EXG-13). Elle obéit à trois règles :

- **explicite** — il n'existe pas de couverture tacite, déduite du comportement ou présumée d'après les familles « habituelles » : une famille non déclarée est non couverte **par définition** (Définition 1), quel que soit ce que le code saurait faire (I62, § 12) ;
- **par version** — la conformité étant déclarée « par version de moteur » (011 § 8), et la couverture conditionnant les sorties (§ 4), la couverture déclarée est une **composante de la déclaration de conformité** : modifier la couverture, c'est changer de version de moteur au sens du 011 § 8, revalidée intégralement — c'est l'application directe du raffinement du 016 § 5.1 (« rendre une telle famille applicable est une évolution du moteur, intégralement revalidée (011 § 8) ») ;
...
> | Erreur | Condition |
> |---|---|
> | **registre non couvert** | après bonne formation et cohérence (le patron du 014 § 5.3) : au moins une convention en vigueur de ℛ appartient à une famille — dès lors l'une des huit connues — hors de la couverture déclarée du moteur invoqué |
>
...
Deux justifications — la bonne fondation pour les trois premiers étages, l'attribution pour l'ordre entier :

- **bonne fondation, pour les trois premiers étages** : chacun présuppose le précédent — la forme ne se vérifie que sur un registre présent ; la cohérence ne se vérifie que sur des conventions dont la forme a livré les champs (dépendances, familles — 014 § 5.3 : la cohérence s'évalue « après bonne formation »). La couverture, elle, est décidable dès la forme acquise : la famille de chaque convention en vigueur est un champ livré par la forme, et la déclaration précède toute invocation (§ 3). Sa place en dernier n'est donc pas forcée — elle est normative, et fondée par l'attribution ;
- **attribution** : les trois premiers défauts sont **intrinsèques au registre** — ils appartiennent à la gouvernance, qui les corrige dans ℛ ; le quatrième est **relatif au moteur** — il appartient à sa couverture déclarée, qui n'évolue que par une évolution de moteur revalidée (016 § 5.1). Signaler l'intrinsèque avant le relatif adresse chaque défaut à qui peut le corriger — et interdit qu'un défaut relatif au moteur masque un défaut de gouvernance.
...
- **la classe** : tout couple (Ω, ℛ) où ℛ est cohérent et contient au moins une convention en vigueur hors de l'ensemble {EQ-01 v1, CE-01 v1} — les seules que le moteur v1 applique réellement (016 § 4.1, report 1 : application « par identifiant codé »). Cette caractérisation décrit le comportement constaté de la v1, un fait de clôture — jamais une déclaration de couverture rétroactive : appliquant par identifiant et non par famille, la v1 n'a aucune couverture au sens du § 2 ;
...
- **le comportement conforme au présent contrat** — il dépend de la couverture déclarée du moteur invoqué, et la classe se scinde en deux sous-classes : lorsque les conventions excédentaires appartiennent toutes à des familles couvertes, le comportement conforme est un **W complet** appliquant tout le contenu de ℛ — un W différent de celui que la v1 émettait ; lorsqu'au moins une appartient à une famille hors couverture, c'est l'erreur « **registre non couvert** », aucun W. La première sous-classe n'est pas vide en droit : tout moteur conforme couvre au moins interprétation et élection (§ 10), donc toute convention excédentaire de ces deux familles en relève — l'existence de tels registres cohérents relevant du prédicat du 011 § 5, intrinsèque à ℛ (§ 6), jamais du moteur. Dans les deux cas, plus jamais de W silencieusement partiel — les deux issues sont la correction, sous ses deux formes, de la même non-conformité ;
- **la déclaration rétroactive** : conformément au mécanisme du 011 § 9, la v1 est déclarée **non conforme rétroactivement sur cette classe d'index** — et sur elle seule : sa conformité déclarée en son temps sur (Ω_corpus1, ℛ₀), et la validité de ses sorties passées sous leur index (I23, I57) sur tout index dont le registre se limite aux conventions qu'elle applique, demeurent entières.

---

## 10. La validation

- **W₀ est strictement inchangé.** ℛ₀ = {EQ-01 v1 (interprétation), CE-01 v1 (élection)} : tout moteur conforme doit produire W₀ depuis (Ω_corpus1, ℛ₀) (EXG-26, rappelé par 016 § 6 et I59) — or un registre non couvert produit l'erreur du § 6, jamais un W (§ 4) : donc tout moteur conforme couvre au moins les familles interprétation et élection, donc ℛ₀ est couvert par tout moteur conforme, donc l'erreur du § 6 est **indéclenchable sur l'index de l'oracle**. Le présent acte n'est pas une révision d'oracle : le report 6 du 016 § 4.2 reste le seul cas de ce type. ∎
- **La batterie s'étend — et l'exigence de provocation se borne au satisfiable.** Le 011 § 8 (point 4) exige que chaque erreur du § 5 soit provoquée « sur des entrées construites pour les provoquer » : la table comptant sept entrées, la batterie compte un cas de plus. Un cas limite naît de la clôture des familles : pour un moteur dont la couverture déclarée est les huit familles du 014 § 5.1, aucun registre bien formé n'est non couvert — la septième erreur y est improvocable par construction. **Raffinement assumé du 011 § 8, point 4** : l'exigence de provocation porte sur chaque erreur dont la condition est satisfiable pour la version validée ; lorsqu'elle est insatisfiable, la vacuité est **démontrée et consignée dans la déclaration de conformité** — une exigence honorée par démonstration, jamais une dispense ; pour la septième erreur, la démonstration se lit directement sur la déclaration de couverture. La clause du 011 § 8 présuppose la constructibilité (« construites pour les provoquer ») : la borne explicite ce présupposé, elle ne retire rien (016 § 6 : le contrat public n'est jamais rétréci ; I58). Aucune autre clause du contrat de validation ne change.
- **Une espèce nouvelle de fixtures.** Les actifs de test gagnent des registres **valides, cohérents et non couverts** — la première espèce de fixture qui n'est pas « cassée » en soi : son défaut n'existe que relativement à la couverture du moteur testé. Leur construction n'exige aucune famille nouvelle réellement applicable : une convention conforme d'une famille non couverte suffit, sous la seule contrainte — commune à toute fixture registre — que l'ensemble résultant satisfasse le prédicat de cohérence.
...
| 011 § 10, clôture (« Le contrat public de ce document n'est étendu que par ce chemin ») | le contrat d'erreur s'étend sans famille nouvelle | le chemin emprunté est bien celui du 011 § 10 — le document d'abord (I36), l'évolution de moteur revalidée ensuite (011 § 8) — et l'extension est celle que le 016 § 4.1 mandate expressément (« une extension du contrat d'erreur : un acte documentaire préalable »). ∎ |
| 011 § 8, conformité par version | la couverture pourrait sembler une donnée hors déclaration | raffinement assumé, déclaré en en-tête : composante de la déclaration de conformité (§ 3) — extension, aucun retrait. ∎ |
| 011 § 8, point 4 (chaque erreur provoquée) | improvocable si la couverture déclarée est les huit familles | raffinement assumé, déclaré en en-tête et motivé au § 10 : exigence bornée au satisfiable, vacuité démontrée et consignée — jamais une dispense (I58). ∎ |
...
| 014 § 1, C2 (« refuse », trois cas) | un quatrième cas s'ajoute | complément assumé, déclaré en en-tête (§ 5), symétrique du cas « Ω incompatible » que C1 porte déjà. ∎ |
...
> *Démonstration.* La couverture est une précondition (§ 4), vérifiée par C2 (§ 5), dont la clause « garantit » assure que rien ne la franchit sans établissement des garanties registre (014 § 1, C2, étendue au § 5). C2 étant la seule frontière de ℛ (014 § 1 : seule couche à connaître sa représentation) et les circulations inter-couches étant closes par les contrats du 014 § 3 (aucun canal hors table), aucun référentiel non couvert ne peut atteindre C3–C5 — les seules couches consommatrices de conventions (014 § 3 ; C6 ne reçoit de ℛ que l'identité de son état) ; et « entier ou absent » (011 § 4) exclut tout W partiel émis avant l'échec. Une dérivation sous registre non couvert exigerait donc un canal qui n'existe dans aucun contrat — elle est impossible par construction. ∎

> **I62 — La couverture est déclarée, jamais implicite.**
> *Démonstration.* Sous la Définition 1, l'énoncé est vrai par construction : la couverture est l'ensemble déclaré. Il reste à démontrer que ce choix définitoire est forcé — qu'aucune couverture non déclarée n'aurait pu fonder le régime. Par I37 (011 § 12), « ce qui ne passe pas par le contrat n'existe pas » pour les consommateurs : une capacité non déclarée est un intérieur du moteur, contractuellement inexistant — une précondition publique (§ 4) ne peut pas reposer sur elle, et une erreur qui l'invoquerait ne pourrait pas « identifier … la clause violée » comme le 011 § 5 l'exige de toute erreur, faute de référent opposable. Le précédent du 011 § 9 tranche dans le même sens : « le moteur **déclare** les versions qu'il supporte » — le régime des versions de Ω ne consulte jamais ce que le code saurait lire. Corollaire : une couverture déduite du comportement varierait avec lui, rendant la précondition du § 4 circulaire (le comportement définirait la condition de sa propre licéité). L'explicitation est ainsi nécessaire — c'est I13 (« aucune convention n'est implicite »), appliqué au moteur lui-même. ∎

> **I63 — La couverture est une propriété de la version du moteur — jamais du registre, jamais d'une configuration.**
> *Démonstration.* Par élimination des autres supports possibles — le registre, une configuration d'exécution, l'autre entrée. Dans ℛ : interdit par 015 § 1 (« [le registre] ne contient jamais … une référence à une implémentation ») et superflu par I56 (toute convention future est exprimable sans modifier la structure du registre — la couverture n'y a donc aucune place nécessaire). En configuration d'exécution : un réglage dont dépendrait l'issue de l'invocation serait une entrée influençant la sortie hors de (Ω, ℛ), ce que le 011 § 2.2 exclut absolument (« Il n'existe aucune troisième entrée (EXG-02) »). Dans Ω enfin : une couverture qui varierait avec l'autre entrée ferait d'une même version de moteur, selon l'invocation, deux moteurs au sens du § 3 (deux couvertures différentes sont deux moteurs, chacun revalidé — 011 § 8) — la conformité déclarée par version l'exclut. Reste le moteur lui-même ; et puisque la conformité est déclarée « par version de moteur » (011 § 8) et que la couverture conditionne les sorties (§ 4), sa granularité est la version. ∎
...
Le régime d'applicabilité est complet : une notion (la couverture, par famille, par version), une déclaration (explicite, constitutive, composante de la conformité), une précondition (la quatrième du 011 § 4), une erreur (la septième du 011 § 5, symétrique de « Ω incompatible »), un ordre de vérification (total, déterministe), une articulation des cas de famille, un régime de transition (l'écart publié d'I59, avec déclaration rétroactive de non-conformité sur la classe d'index concernée), un régime de validation (la batterie étendue d'un cas, l'exigence de provocation bornée au satisfiable, les fixtures d'espèce nouvelle), et quatre invariants démontrés. Le prédicat de cohérence, le registre, sa grammaire, l'oracle et W₀ sont intacts.
...
| couverture | ensemble des familles que la version de moteur déclare — la déclaration est constitutive et déclarer oblige (EXG-13) ; granularité : la famille (016 § 5.1) ; propriété de la version, jamais du registre ni d'une configuration | 2 |
| déclaration de couverture | constitutive (déclarer, c'est couvrir) ; explicite, par version, stable sous l'index, composante de la déclaration de conformité (011 § 8) ; jamais tacite | 3 |
...
| compatibilité des versions | 011 § 9 borné (« cohérent **et couvert** ») ; écart publié (I59) : classe d'index caractérisée, justification uniforme, comportement conforme scindé selon la couverture du moteur invoqué (W complet corrigé / « registre non couvert »), v1 déclarée non conforme rétroactivement sur cette classe seule | 9 |
| validation | W₀ inchangé (démontré) ; batterie étendue d'un cas, exigence de provocation bornée au satisfiable (raffinement assumé du 011 § 8, point 4) ; fixtures d'espèce nouvelle (valides, cohérentes, non couvertes) | 10 |
| compatibilité documentaire | quatorze clauses figées, chacune traitée nommément — par raffinement, complément, adossement, exclusion ou articulation, selon la table du § 11 — aucune par silence | 11 |
